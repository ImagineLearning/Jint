...
namespace Jint.Tests.Runtime.Domain
{
    public class ArrayConverterTestClass
    {
        ...
        {
            var stringArray = Enumerable.Select(array, item => item.ToString()).ToArray();
    ...
    public class ArrayConverterItem : IConvertible
    {
        ...
        {
            // CF calls ToType when using System.Convert.ChangeType before calling ToString(IFormatProvider)
            return System.Convert.ChangeType(_value, conversionType, provider);
        }
        #endregion
